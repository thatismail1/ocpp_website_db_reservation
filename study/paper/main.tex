...
{\footnotesize
\begin{tabular}{@{}l@{\hspace{6pt}}p{0.66\columnwidth}@{}}
...
$R_{ij},X_{ij}$ & Resistance/reactance shared by the root-to-$i$ and root-to-$j$ paths [p.u.]\\
...
$\gamma_j,\gamma_C$ & Intra-interval drift bound and its measured value at hub~C [kW]\\
...
\resizebox{\columnwidth}{!}{\input{figs/fig_topology}}
...
\begin{figure}[!t]\centering
\resizebox{0.98\columnwidth}{!}{\input{figs/fig_arch}}
...
\subsection{Corner certification at $N$ hubs}\label{sec:corner}
...
\subsection{Exact $N$-hub form of the omitted loss term}
...
\begin{figure}[!t]\centering
\resizebox{0.96\columnwidth}{!}{\input{figs/fig_timing}}
...
\toprule
Set & $R_{mm}$ & $\gamma_C$ & obs. & $2R_{mm}\gamma_C/\Sb$ & ratio\\
\midrule
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{fig1}}]{Author One}
Biography text here.
\end{IEEEbiography}
